...
@WebServlet({ "/admin/exam/addQuestion", "/admin/exam/choose", "/admin/exam/display", "/admin/exam/answer",
		"/admin/exam/addSubject", "/admin/exam/displaySubject", "/admin/exam/deleteSubject" })
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getRequestURI().equals(request.getContextPath() + "/admin/exam/addQuestion")) {
			...
			if (ExamDao.insert(examModel) == true) {
				response.sendRedirect(request.getContextPath() + "/admin/exam/addQuestion"); // redirecting
																								// to
																								// the
																								// same
																								// page
